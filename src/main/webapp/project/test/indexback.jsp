...
<head id="Head1">
	<meta charset="UTF-8">
	<title>爱投宝运营系统-www.aitoubao.com</title>
...
--%>
	<script type="text/javascript" src="common/js/jQuery.easyui.js"></script>
	<script type="text/javascript" src='common/js/outlook2.js'> </script>

	<script type="text/javascript">
		var _menus = {"menus":[
			{"menuid":"1","icon":"icon-sys","menuname":"系统管理",
				"menus":[{"menuname":"项目管理","icon":"icon-nav","url":"/project/info.do"},
...
<div region="north" split="true" border="false" style="overflow: hidden; height: 30px;
        background: url(common/images/layout-browser-hd-bg.gif) #7f99be repeat-x center 50%;
        line-height: 20px;color: #fff; font-family: Verdana, 微软雅黑,黑体">
	<span style="float:right; padding-right:20px;" class="head">欢迎 罗三 <a href="#" id="editpass">修改密码</a> <a href="#" id="loginOut">安全退出</a></span>
	<span style="padding-left:10px; font-size: 16px; "><img src="common/images/blocks.gif" width="20" height="20" align="absmiddle" /> 爱投宝www.aitoubao.com</span>
</div>
<div region="south" split="true" style="height: 30px; background: #D2E0F2; ">
	<div class="footer">By 罗三 Email:113264744@qq.com</div>
</div>
